  ...
  return (
    <div className="flex flex-col items-center">
      <a
        ...
        style={{ backgroundColor: "#000", color: "white", fontFamily: sans }}
        className="px-6 py-3 rounded-xl hover:opacity-90 active:scale-[0.98] transition-all cursor-pointer inline-flex items-center gap-3 no-underline"
      >
      ...
      >
        ...
        <nav className="relative z-10 flex items-center justify-between px-5 md:px-12 py-5 w-full">
          ...
          <a
            ...
            className="px-5 py-2 rounded-full text-sm font-semibold hover:opacity-90 transition-opacity cursor-pointer no-underline inline-flex items-center gap-2"
          >
        ...
        <div className="relative z-10 max-w-6xl mx-auto">
          ...
          <div className="flex flex-col items-center mt-8 gap-7">
            ...
            <a
              ...
              className="px-5 py-2.5 rounded-xl hover:opacity-90 transition-opacity cursor-pointer no-underline inline-flex items-center gap-2.5"
            >
